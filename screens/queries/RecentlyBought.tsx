            ...
            { loading ? (
                ...
                <>
                    <View>
                        ...
                        <Text style={styles.title}>Ingredients recently bought</Text>
                            ...
                            return(
                                <React.Fragment key={index}>
                                    <TouchableOpacity onPress={() => navigation.navigate('EditIngredient', { data: grocery })}>
                                        ...
                                        <Text><Text style={{ fontWeight: 'bold' }}>Bought at:</Text> {grocery.boughtAt ? moment(grocery.boughtAt.toDate()).format('LLL') : ''}</Text>
                                    </TouchableOpacity>
